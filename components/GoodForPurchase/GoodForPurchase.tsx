			...
			<div className={styles.container}>
				...
				<div className={styles.gallery}>
					<div className={styles.mainImageWrapper}>
						...
						{!mainImage && (
							<div style={{ padding: "50%", textAlign: "center", color: "var(--color-neutral)" }}>Немає фото</div>
						)}
					</div>
					{images.length > 1 && (
				...
				<div className={styles.info}>
					...
					<p className={styles.detailContent}>Безкоштовна доставка від 1000 грн.</p>
					...
					{good.color && good.color.length > 0 && (
						<div className={styles.selectorBlock}>
							...
							<p className={styles.selectedValueDisplay}>Обрано: {selectedColor || "—"}</p>
						</div>
					)}
					...
					{good.size && good.size.length > 0 && (
						<div className={styles.selectorBlock}>
							...
							<p className={styles.selectedValueDisplay}>Обрано: {selectedSize || "—"}</p>
						</div>
					)}
